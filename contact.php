...
$header .= "From: Новая заявка <kisonkamyrysenka@gmail.com>\n\n";	
$mail = mail("kisonkamyrysenka@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
