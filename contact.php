...
$header .= "From: Новая заявка <anya.sibagatulina@mail.ru>\n\n";	
$mail = mail("anya.sibagatulina@mail.ru", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
